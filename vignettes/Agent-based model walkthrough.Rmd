...
None of the created examples are meant to directly match previously collected data on the species movements –there are alternative methods built to fit and simulate movements from existing data– more provide some biological context for a range of simulation parametrisations.
