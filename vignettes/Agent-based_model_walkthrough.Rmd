...
BADGER_restData <- c(0.65, 0, 24, 24)

## multiple cycle additions
c0 <- c(0.15, 0, 24, 24*28) # seasonal

BADGER_cycleMat <- rbind(c0)
BADGER_cycleMat
```
...
KINGCOBRA_restData <- c(0.65, 0, 24, 24)

## multiple cycle additions
c0 <- c(0.2, 0, 24, 24*4) # digest
c1 <- c(0.15, 0, 24, 24*28) # seasonal

KINGCOBRA_cycleMat <- rbind(c0, c1)
KINGCOBRA_cycleMat
```
...
``` {r runSimulations, include=TRUE, eval=FALSE}
simSteps <- 24*60 *28
des_options <- 10
options <- 12
