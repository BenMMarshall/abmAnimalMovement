...
b_stepPlot <- data.frame(
  ...
  ggplot() +
  geom_density(aes(x = value, fill = var), alpha = 0.5, colour = NA) +
...
```{r BADGERmoveCharFigure, echo=FALSE, eval=TRUE, fig.align='center', fig.width=5, fig.height=5, fig.cap="...."}
...
We can compare the inputs from Figure \@ref(fig:BADGERsettingMoveDes) to the observed outputs in Figure \@ref(fig:BADGERmoveCharFigure) and see that they largely agree as expected.
...
Figures \@ref(fig:VULTUREsettingMoveDes) and \@ref(fig:KINGCOBRAsettingMoveDes) describe the inputs for the Vulture and King Cobra example respectively, and are comparable to figures \@ref(fig:VULTUREmoveCharFigure) and \@ref(fig:KINGCOBRAmoveCharFigure).
...
```{r mapsFigure, echo=FALSE, eval=TRUE, warning=FALSE, fig.align='center', fig.width=5, fig.height=2.25, fig.cap="...."}
...
```{r cycleFigure, echo=FALSE, eval=TRUE, fig.align='center', fig.width=8, fig.height=14, fig.cap="...."}
...
We can check the number of time steps in each behavioural state throughout the year. 
