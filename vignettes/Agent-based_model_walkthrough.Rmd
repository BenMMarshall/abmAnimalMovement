...
BADGER_k_step <- c(1.5, 1.25, 0.25)
BADGER_s_step <- c(0.25, 0.25, 0.15)
...
BADGER_rest_Cycle <- c(0.45, 0, 24, 24)
...
VULTURE_rest_Cycle <- c(0.40, 0, 24, 24)

## multiple cycle additions
c0 <- c(0.15, 0, 24, 24*28) # seasonal

VULTURE_additional_Cycles <- rbind(c0)
VULTURE_additional_Cycles
```
