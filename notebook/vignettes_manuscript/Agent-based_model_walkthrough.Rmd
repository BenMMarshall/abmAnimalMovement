...
author2: "a2"
affiliation1: "University of Stirling"
affiliation2: "afill2"
date: "`r Sys.Date()`"
output:
...
```{r rfOptions, echo = FALSE, eval=FALSE}
# RandomFields::RFoptions(install="no")
```

```{r landscapeLayers, echo=FALSE, eval=FALSE}
...
```{r plotMatrixFunction, eval=FALSE, echo=FALSE}
...
```{r BADGERlayersFigure, eval=FALSE, echo=FALSE, fig.align='center', fig.width=10, fig.height=5, fig.cap="The three resulting landscape layers to be fed into the simulation for the badger example: shelter quality, foraging resources, movement ease."}
...
```{r BADGERsettingMoveDes, eval=FALSE}
...
```{r BADGERsettingMoveDesPlot, echo=FALSE, eval=FALSE, fig.align='center', fig.width=5, fig.height=5, fig.cap="The distribution of step lengths, and corresponding box plot for the badger example. The lower plot shows the distribution used to generate potential foraging desintations."}
...
```{r BADGERsettingAvoid, eval=FALSE}
...
```{r BADGERsettingCycle, eval=FALSE}
...
```{r VULTUREmovematrix, eval=FALSE}
...
```{r VULTUREsettingMoveDes, eval=FALSE}
...
```{r VULTUREsettingMoveDesPlot, echo=FALSE, eval=FALSE, fig.align='center', fig.width=5, fig.height=5, fig.cap="The distribution of step lengths, and corresponding box plot for the vulture example. The lower plot shows the distribution used to generate potential foraging desintations."}
...
```{r VULTUREsettingShelter, eval=FALSE}
...
```{r VULTUREforagematrix, eval=FALSE}
...
```{r VULTURElayersFigure, eval=FALSE, echo=FALSE, fig.align='center', fig.width=10, fig.height=5, fig.cap="The three resulting landscape layers to be fed into the simulation for the vulture example: shelter quality, foraging resources, movement ease."}
...
```{r VULTUREsettingCycle, eval=FALSE}
...
```{r KINGCOBRAsettingShelter, eval=FALSE}
...
```{r KINGCOBRAsettingCycle, eval=FALSE}
...
```{r KINGCOBRAmoveMatrix, eval=FALSE}
...
```{r KINGCOBRAlayersFigure, eval=FALSE, echo=FALSE, fig.align='center', fig.width=10, fig.height=5, fig.cap="The three resulting landscape layers to be fed into the simulation for the king cobra example: shelter quality, foraging resources, movement ease."}
...
```{r KINGCOBRAsettingMoveDes, eval=FALSE}
...
```{r KINGCOBRAsettingMoveDesPlot, echo=FALSE, eval=FALSE, fig.align='center', fig.width=5, fig.height=5, fig.cap="The distribution of step lengths, and corresponding box plot for the king cobra example. The lower plot shows the distribution used to generate potential foraging desintations."}
...
```{r defineStart, include=TRUE, eval=FALSE}
...
``` {r runSimulationsRUN, include=FALSE, eval=FALSE}
simSteps <- 24*60 *365
des_options <- 10
options <- 12
...
```{r moveCharFigureGen, echo=FALSE, eval=FALSE}
...
```{r cycleSeasonalFigure, echo=FALSE, eval=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.width=8, fig.height=5, fig.cap="...."}
