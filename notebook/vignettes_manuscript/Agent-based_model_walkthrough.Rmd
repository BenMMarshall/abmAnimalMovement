...
However, the on the whole analysis approaches to maximise the information extracted has arguably lagged behind the technological and data improvements [@joo_recent_2022].
...
```{r VULTUREsettingMoveDes, eval=TRUE}
...
```{r VULTUREsettingShelter, eval=TRUE}
...
```{r VULTUREforagematrix, eval=TRUE}
...
```{r VULTUREsettingCycle, eval=TRUE}
...
```{r KINGCOBRAsettingShelter, eval=TRUE}
...
```{r KINGCOBRAsettingCycle, eval=TRUE}
...
```{r KINGCOBRAmoveMatrix, eval=TRUE}
...
```{r KINGCOBRAsettingMoveDes, eval=TRUE}
