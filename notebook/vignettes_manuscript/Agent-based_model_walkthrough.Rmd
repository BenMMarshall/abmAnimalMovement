...
During the simulation the badger will randomly select a sett to return to, weighted by the values supplied via the shelter quality environmental layer [Figure \@ref(BADGERlayersFigure)], each time it enters the resting behavioural state.
