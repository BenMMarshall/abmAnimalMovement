...
b0 <- c(0.8, 0.001, 0.001) # rest
b1 <- c(0.005, 0.96, 0.001) # explore/move
b2 <- c(0.005, 0.001, 0.97) # forage
...
BADGER_rest_Cycle <- c(0.2, 0, 24, 24)
...
VULTURE_rest_Cycle <- c(0.4, 0.1, 24, 24)
...
VULTURE_behaveMatrix[2,3] <- 0.0025
VULTURE_behaveMatrix[3,2] <- 0.01
...
KINGCOBRA_rest_Cycle <- c(0, 0, 24, 24)

## multiple cycle additions
c0 <- c(0.2, 0, 24, 24*4) # digest
c1 <- c(0.1, 0, 24 * (365/2), 24* 365 ) # seasonal
...
KINGCOBRA_movementMatrix[1200:1240,1:2000] <- KINGCOBRA_movementMatrix[1200:1240,1:2000] - 1
KINGCOBRA_movementMatrix[1:2000,850:890] <- KINGCOBRA_movementMatrix[1:2000,850:890] - 1
...
```{r KINGCOBRAsettingsAll, ref.label=c('KINGCOBRAsettingShelter','KINGCOBRAsettingMoveDes', 'KINGCOBRAsettingCycle', 'KINGCOBRAmoveMatrix')}
```
