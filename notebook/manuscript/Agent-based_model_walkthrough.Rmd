...
for(species in vecSpecies){
  ...
  write.csv(x = simResultsList[[species]]$options,
            file = here::here("notebook",
                              "manuscript",
                              "eg_simdata",
                              paste0("eg_simdata_", species, "_options.csv")),
            row.names = FALSE)
}
...
The example badger, vulture, and king cobra data simulated for this manuscript is available on Zenodo: BenMMarshall/abmAnimalMovement https://doi.org/10.5281/zenodo.6951937 (`notebook/manuscript/eg_simdata`).
Source code to reproduce the results and manuscript are available alongside the software, archived at: https://doi.org/10.5281/zenodo.6951938.
