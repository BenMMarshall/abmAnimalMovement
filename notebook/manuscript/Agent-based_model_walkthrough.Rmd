...
Step length parameters are all larger and more variable, along with destination ranges [\@ref(fig:VULTUREsettingMoveDesPlot)].
...
We maximise movement ease across the entire landscape, while also lowering the foraging quality for an area to the West reflecting lower resources in that area [\@ref(fig:VULTURElayersFigure)].
...
Compared to the vulture, the king cobra movements are smaller, but king cobras can still occupy large areas [\@ref(fig:KINGCOBRAsettingMoveDesPlot)].
...
We construct this by altering the values in the environmental matrices, minimising the weighting in cells following two perpendicular lines [\@ref(fig:KINGCOBRAlayersFigure)].
