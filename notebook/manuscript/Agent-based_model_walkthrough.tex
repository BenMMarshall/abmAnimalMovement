...
We predefine a suite of parameters describing the movement and behaviour characteristics of the animal, storing them as object we can later input into the \texttt{abm\_simulate} function.
