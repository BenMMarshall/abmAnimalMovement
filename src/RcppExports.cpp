...
// cpp_abm_simulate
Rcpp::List cpp_abm_simulate(double startx, double starty, int steps, int des_options, int options, std::vector<double> shelter_locs_x, std::vector<double> shelter_locs_y, std::vector<double> forage_locs_x, std::vector<double> forage_locs_y, std::vector<double> k_step, std::vector<double> s_step, std::vector<double> mu_angle, std::vector<double> k_angle, std::vector<double> b0_Options, std::vector<double> b1_Options, std::vector<double> b2_Options, double rest_Cycle_A, double rest_Cycle_M, double rest_Cycle_PHI, double rest_Cycle_TAU, Rcpp::NumericMatrix memShelterMatrix, Rcpp::NumericMatrix forageMatrix, Rcpp::NumericMatrix moveMatrix, std::vector<int> seeds);
RcppExport SEXP _abmAnimalMovement_cpp_abm_simulate(SEXP startxSEXP, SEXP startySEXP, SEXP stepsSEXP, SEXP des_optionsSEXP, SEXP optionsSEXP, SEXP shelter_locs_xSEXP, SEXP shelter_locs_ySEXP, SEXP forage_locs_xSEXP, SEXP forage_locs_ySEXP, SEXP k_stepSEXP, SEXP s_stepSEXP, SEXP mu_angleSEXP, SEXP k_angleSEXP, SEXP b0_OptionsSEXP, SEXP b1_OptionsSEXP, SEXP b2_OptionsSEXP, SEXP rest_Cycle_ASEXP, SEXP rest_Cycle_MSEXP, SEXP rest_Cycle_PHISEXP, SEXP rest_Cycle_TAUSEXP, SEXP memShelterMatrixSEXP, SEXP forageMatrixSEXP, SEXP moveMatrixSEXP, SEXP seedsSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<double> >::type forage_locs_x(forage_locs_xSEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type forage_locs_y(forage_locs_ySEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(cpp_abm_simulate(startx, starty, steps, des_options, options, shelter_locs_x, shelter_locs_y, forage_locs_x, forage_locs_y, k_step, s_step, mu_angle, k_angle, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, memShelterMatrix, forageMatrix, moveMatrix, seeds));
...
static const R_CallMethodDef CallEntries[] = {
    {"_abmAnimalMovement_cpp_abm_simulate", (DL_FUNC) &_abmAnimalMovement_cpp_abm_simulate, 24},
