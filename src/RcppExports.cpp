...
RcppExport SEXP _abmAnimalMovement_cpp_abm_simulate(SEXP startxSEXP, SEXP startySEXP, SEXP stepsSEXP, SEXP des_optionsSEXP, SEXP optionsSEXP, SEXP shelter_locs_xSEXP, SEXP shelter_locs_ySEXP, SEXP k_stepSEXP, SEXP s_stepSEXP, SEXP mu_angleSEXP, SEXP k_angleSEXP, SEXP b0_OptionsSEXP, SEXP b1_OptionsSEXP, SEXP b2_OptionsSEXP, SEXP rest_Cycle_ASEXP, SEXP rest_Cycle_MSEXP, SEXP rest_Cycle_PHISEXP, SEXP rest_Cycle_TAUSEXP, SEXP memShelterMatrixSEXP, SEXP forageMatrixSEXP, SEXP moveMatrixSEXP, SEXP seedsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(cpp_abm_simulate(startx, starty, steps, des_options, options, shelter_locs_x, shelter_locs_y, k_step, s_step, mu_angle, k_angle, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, memShelterMatrix, forageMatrix, moveMatrix, seeds));
...
static const R_CallMethodDef CallEntries[] = {
    {"_abmAnimalMovement_cpp_abm_simulate", (DL_FUNC) &_abmAnimalMovement_cpp_abm_simulate, 22},
