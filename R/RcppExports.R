...
cpp_abm_simulate <- function(startx, starty, steps, des_options, options, k_step, s_step, mu_angle, k_angle, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, memShelterMatrix, forageMatrix, moveMatrix, seeds) {
    .Call('_abmAnimalMovement_cpp_abm_simulate', PACKAGE = 'abmAnimalMovement', startx, starty, steps, des_options, options, k_step, s_step, mu_angle, k_angle, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, memShelterMatrix, forageMatrix, moveMatrix, seeds)
}
